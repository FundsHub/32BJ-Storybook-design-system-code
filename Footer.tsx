    ...
    <footer className={`ds-footer ${mobile ? 'ds-footer--mobile' : ''}`} data-fund={fund} data-figma-node="1752:9817">
      <div className="ds-footer__inner">
        ...
        <div className="ds-footer__social" aria-label="Social links">
          <a className="ds-footer__social-icon" href="#" aria-label="32BJ Benefit Funds on Facebook"><img src={productionAssets.facebook} alt="" /></a>
          <a className="ds-footer__social-icon" href="#" aria-label="32BJ Benefit Funds on Bluesky"><img src={productionAssets.bluesky} alt="" /></a>
          <a className="ds-footer__social-icon" href="#" aria-label="32BJ Benefit Funds on Instagram"><img src={productionAssets.instagram} alt="" /></a>
          <a className="ds-footer__qr" href="https://32bjfunds.org/" aria-label="Open 32BJ Benefit Funds website"><img src={productionAssets.footerQr} alt="" /></a>
        </div>
